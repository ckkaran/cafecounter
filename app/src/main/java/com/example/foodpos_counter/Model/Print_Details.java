...
public class Print_Details {
    ...
    @Expose
    private ArrayList<Print_Items> orderItems;

    public Print_Details(String kitchenId, String kitchenName, String ip, String port, String orderId, String saleinvoice, String tablename, String cutomertypeName, String waiter, String tokenno, String orderDate, String orderTime, ArrayList<Print_Items> orderItems) {
    ...
    public ArrayList<Print_Items> getOrderItems() {
        return orderItems;
    }

    public void setOrderItems(ArrayList<Print_Items> orderItems) {
        this.orderItems = orderItems;
    }
}
