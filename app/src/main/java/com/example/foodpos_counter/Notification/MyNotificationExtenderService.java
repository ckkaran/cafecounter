...
public class MyNotificationExtenderService implements OneSignal.OSRemoteNotificationReceivedHandler {
    ...
    public void remoteNotificationReceived(Context context, OSNotificationReceivedEvent notificationReceivedEvent) {
        ...
        mutableNotification.setExtender(builder -> {
            ...
            Bitmap icon = BitmapFactory.decodeResource(ApplicationClass.getContext().getResources(),
                    R.mipmap.ic_launcher);
            builder.setLargeIcon(icon);
//                Bitmap icon1 = BitmapFactory.decodeResource(ApplicationClass.getContext().getResources(), R.drawable.anounce);
            builder.setSmallIcon(R.mipmap.ic_launcher);
//            builder.setColor(new BigInteger("FF00FF00", 16).intValue());
            builder.setColor(new BigInteger("00E30247", 16).intValue());
